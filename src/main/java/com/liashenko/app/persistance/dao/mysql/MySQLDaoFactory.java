...
public class MySQLDaoFactory implements DaoFactory  {
    ...
    @Override
    public Optional<GenericJDBCDao> getDao(Connection connection, Class clazz, ResourceBundle localeQueries) throws DAOException {
        ...
        if (clazz == PricePerKmForVagon.class) return Optional.of(new PricePerKmForVagonDaoImpl(connection, localeQueries));
