...
public class ShowRegistrationViewCommandTest {
    @Mock
    ...
    private ICommand command = new ShowRegistrationViewCommand(serviceFactory);

    @Test
    public void returnsExpectedPath() throws ServletException, IOException {
        HttpServletRequest request = mock(HttpServletRequest.class);
        HttpServletResponse response = mock(HttpServletResponse.class);
        String expectedPath = PageManagerConf.getInstance().getProperty(PageManagerConf.REGISTRATION_PAGE_PATH);
