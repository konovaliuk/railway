                        ...
                        <div class="form-group col-lg-4 col-md-4 col-sm-4">
                            <div class="input-group">
                                <input aria-describedby="sizing-addon1" type="text" class="form-control input-lg"
                                       name="from" id="from" value="${sessionScope.FROM_STATION_NAME_ATTR}"
                                ...
                                <input type="hidden" id="fromId" name="fromId"
                                       value="${sessionScope.FROM_STATION_ID_ATTR}"/>
                            </div>
                        </div>

                        <div class="form-group col-lg-4 col-md-4 col-sm-4">
                            <div class="input-group">
                                <input aria-describedby="sizing-addon2" type="text" class="form-control input-lg"
                                       name="to" value="${sessionScope.TO_STATION_NAME_ATTR}"
                        ...
                        <div class="form-group col-lg-3 col-md-3 col-sm-3">
                            <div class="input-group">
                                <input type="text" class="form-control input-lg" name="date" id="date"
                                       value="${sessionScope.DATE_ATTR}" autocomplete="off"
